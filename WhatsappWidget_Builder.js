...
<form id="form">
    <table>
        <tr>
                ...
                <td>
                <p>Message to send</p>
                <input id="builder_message" type="text" placeholder="Enter Message to send">
                </td>
                </tr>
                <tr>
                <td>
...
`;
      class WhatsappWidgetBuilderPanel extends HTMLElement {
         constructor() {
            super();
         ...
         _submit(e) {
               ...
               this.dispatchEvent(
                  new CustomEvent("propertiesChanged", {
                     detail: {
                        properties: {
                           number: this.number,message: this.message,caption: this.caption
                        },
                     },
                  })
               );
   ...
   customElements.define("com-rohitchouhan-sap-whatsappwidget-builder", 
      WhatsappWidgetBuilderPanel
   );
})();